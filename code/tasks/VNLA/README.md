...
**NOTE**: you may not get exactly the numbers reported in the paper because different types of GPU models/CUDA/cuDNN may have different implementations for randomization. However, the difference should not be significant. 
