...
**NOTE**: you may get slightly different results from those reported in the paper because different types of GPU models/CUDA/cuDNN may implement randomization differently. 
